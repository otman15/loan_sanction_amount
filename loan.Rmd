...
The evaluation is based on the RMSE - Root Mean Squared Error built under the caret package. $$\mbox{RMSE} = \sqrt{\frac{1}{n}\sum_{i=1}^{n}(y_i - \hat{y_i})^2}$$
  \vspace{0.5cm}
...
The zip file was loaded from kaggle, we read it and assign the train data to loan_data.
```{r, include=FALSE, echo=FALSE}
unzip("loan.zip")
